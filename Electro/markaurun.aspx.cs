...
namespace Electro
{
    public partial class markaurun : System.Web.UI.Page
    {
        ...
        private void MarklatıDoldur()
        {
            int id = Convert.ToInt32(Request.QueryString["marId"]);


            var sonuc = (from m in elec.Urunler
                         where m.MarkaId == id
                         select m).ToList();
            rptMarkaUrun.DataSource = sonuc;
            rptMarkaUrun.DataBind();
        }
        ...
        protected void rptMarkaUrun_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
