<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="markaurun.aspx.cs" Inherits="Electro.markaurun" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1"  RepeatColumns="3" runat="server">
    <div class="center_title_bar">Markalar</div>
    <asp:Repeater ID="rptMarkaUrun" runat="server" OnItemCommand="rptMarkaUrun_ItemCommand">
            ...
            <div class="prod_box">
                ...
                <div class="center_prod_box">
                   ...
                   <div class="product_title"><a href='<%# string.Format("urundetay.aspx?urunId={0}", Eval("Id")) %>'>
                    ...
                    <div class="prod_price"> <span><asp:Label ID="lblFiyat" runat="server" Text='<%# string.Format("{0:N}", Eval("Fiyat")) %>'></asp:Label></span></div>
